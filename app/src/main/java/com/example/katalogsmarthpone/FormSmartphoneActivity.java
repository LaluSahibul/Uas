...
public class FormSmartphoneActivity extends AppCompatActivity {
    ...
    Button btnSimpan;
    TextInputLayout tilDeskripsi,tilNilai, tilModel, tilBrand;
    EditText edtTgl;
    Spinner spJenisTransaksi;
    Date tanggalTransaksi;
    final String[] tipeTransaksi = {Smartphone.SAMSUNG, Smartphone.OPPO, Smartphone.REALME, Smartphone.VIVO, Smartphone.XIAOMI, Smartphone.IPHONE};
